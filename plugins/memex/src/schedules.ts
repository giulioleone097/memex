...
function parseScheduleId(value: unknown, code: MemexErrorCode): string {
...
function parseCron(value: unknown, code: MemexErrorCode): string {
...
function parseTimezone(value: unknown, code: MemexErrorCode): string {
  if (
    typeof value !== "string" ||
    value.length === 0 ||
    value.length > 128 ||
...
function parseSourceId(value: unknown, code: MemexErrorCode): string {
  if (
    typeof value !== "string" ||
    value.trim().length === 0 ||
    value.length > 512 ||
