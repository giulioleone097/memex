...
function redactValue(value, ancestors) {
    ...
    throw new MemexError("INVALID_ARGUMENT", "Sensitive data redaction requires a JSON-compatible value.");
}
function redactRecord(record, ancestors) {
    ...
    for (const [rawKey, rawValue] of Object.entries(record)) {
        ...
        if (Object.hasOwn(redacted, key)) {
            throw new MemexError("INVALID_ARGUMENT", "Sensitive data redaction produced duplicate object keys.");
        }
...
function withObjectGuard(value, ancestors, operation) {
    if (ancestors.has(value)) {
        throw new MemexError("INVALID_ARGUMENT", "Sensitive data redaction does not accept cyclic values.");
    }
    ancestors.add(value);
    try {
        return operation();
