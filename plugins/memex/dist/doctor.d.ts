...
export declare const DOCTOR_CHECK_IDS: readonly ["node", "permissions", "git", "manifests", "config", "state", "locks", "retention", "secret-leakage", "vendor-assets", "graph-cypher", "legacy-storage"];
